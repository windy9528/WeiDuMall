...
public abstract class HomeModel {
    ...
    public HomeModel(ImplView implView) {
    ...
    public void requestData(final Object... args) {
        ...
        HomeApi homeApi = RetrofitUtil.getHttpUtil().create(HomeApi.class);

        disposable = getModel(homeApi, args)
     ...
     * @return
     */
    protected abstract Observable getModel(HomeApi homeApi, Object... args);
