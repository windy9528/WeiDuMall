...
public abstract class CircleModel {
    ...
    public CircleModel(ImplView implView) {
    ...
    public void requestData(final Object... args) {
        ...
        CircleApi circleApi = RetrofitUtil.getHttpUtil().create(CircleApi.class);

        disposable = getModel(circleApi, args)
     ...
     * @return
     */
    protected abstract Observable getModel(CircleApi circleApi, Object... args);
